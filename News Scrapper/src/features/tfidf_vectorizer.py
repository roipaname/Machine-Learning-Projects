...
class TFIDFFeatureExtractor:
    ...
    def __init__(
        ...
        Args:
            ...
            ngram_range: (min_n, max_n) tuple for n-gram extraction
        ...
        logger.info(f"Initialized TF-IDF extractor with max_features={max_features}")
...
if __name__ == '__main__':
    ...
    logger.info("TF-IDF testing complete!")